...
download.file("https://raw.githubusercontent.com/p3piit/exp_rawdata/main/starwars.sav", "starwars.sav")
setwd("/home/web_user")
```
...
Use the haven::read_spss() function to load the SPSS dataset saved as "starwars.sav" inside the directory data.
